...
# save
saveRDS(rur_pop_share, file.path(proc_path, glue("harmonized/rur_pop_share_{grid_sel}_{year_sel}_{iso3c_sel}.rds")))
...
#view_4p_f("bana", "score", df = score_df)
# view_4p_f("maiz", "score", df = score_df)
#view_4p_f("rice", "score", df = score_df)
#view_4p_f("vege", "score", df = score_df)


############### SAVE ###############
saveRDS(score_df, file.path(proc_path, paste0("harmonized/score_", grid_sel, "_", year_sel, "_", iso3c_sel, ".rds")))
